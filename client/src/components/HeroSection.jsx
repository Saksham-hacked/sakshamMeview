      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <Button className="btn-primary bg-red-600 text-lg group">
              <Star className="mr-2 h-5 w-5" />
              Sign Up Free
              <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
            </Button>
            
            <Button className="btn-secondary bg-red-600 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            ...
            <div className="glass-card p-6 text-center hover-scale">
              ...
              <h3 className="text-white font-medium mb-1">Live Discussions</h3>
              <p className="text-white/60 text-sm">Chat about new releases in real-time</p>
            </div>
            
            <div className="glass-card p-6 text-center hover-scale">
              <Play className="h-8 w-8 text-yellow-400 mb-3 mx-auto" />
              <h3 className="text-white font-medium mb-1">Watch Instantly</h3>
              <p className="text-white/60 text-sm">Find where to stream your next film</p>
            </div>
          </div>
        </div>
      </div>
